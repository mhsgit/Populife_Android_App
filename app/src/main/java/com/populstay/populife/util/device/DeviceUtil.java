...
public class DeviceUtil {
	...
	public static boolean isIgnoreAccountRemoteLoginVerify(String account){
		//处理异地登录
		for (String accountWhite : Constant.mIgnoreRemoteLoginAccountArr) {
			// 测试账号，不检测异地登录，直接登录进入主页
			if (TextUtils.equals(accountWhite,account)){
				return true;
			}
		}
		return false;
